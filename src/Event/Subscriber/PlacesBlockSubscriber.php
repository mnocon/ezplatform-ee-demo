...
class PlacesBlockSubscriber extends AbstractBlockEvent implements EventSubscriberInterface
{
    private const BLOCK_IDENTIFIER = 'places';
    private const CONTENT_TYPE_IDENTIFIER = 'place';
